...
//		dashboard.start();
		...
		System.out.println("\nOpening Balances: ");
		System.out.println("EURO:"+account.getOpeningBalance_EURO());
		System.out.println("GBP:"+account.getOpeningBalance_GBP());
		System.out.println("USD:"+account.getOpeningBalance_USD());
		System.out.println("\n1. Initiate Cashflow\n2. Display end of the day balance in accounts\n3. Net balance in base currency\n4. Calcuulate lend/borrow\n5. End Day");
		...
		do {
			...
			case 2:	
				...
				break;
			case 3: market.display_EOLBal_In_Base();
			break;
			case 4:interest.start();
			break;
			}
