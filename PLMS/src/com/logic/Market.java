...
//		openbal=50000000;    //opening bal to be fetched from dao marketclass
	...
	public double cal_netBaseEURO() {
		...
		if (moneymarket.getAmount_USD() > 0)
			EURO_Base = EURO_Base + (moneymarket.getAmount_USD() / rate.EUR_USD_ASK);
		else
			EURO_Base = EURO_Base + (moneymarket.getAmount_USD() / rate.EUR_USD_BID);

		if (moneymarket.getAmount_GBP() > 0)
			EURO_Base = EURO_Base + (moneymarket.getAmount_GBP() / rate.EUR_GBP_ASK);
		else
			EURO_Base = EURO_Base + (moneymarket.getAmount_GBP() / rate.EUR_GBP_BID);
	...
	public double cal_netBaseGBP() {
		...
		if (moneymarket.getAmount_USD() > 0)
			GBP_Base = GBP_Base + (moneymarket.getAmount_USD() / rate.GBP_USD_ASK);
		else
			GBP_Base = GBP_Base + (moneymarket.getAmount_USD() / rate.GBP_USD_BID);

		if (moneymarket.getAmount_EURO() > 0)
			GBP_Base = GBP_Base + (moneymarket.getAmount_EURO() * rate.EUR_GBP_BID);
		else
			GBP_Base = GBP_Base + (moneymarket.getAmount_EURO() * rate.EUR_GBP_ASK);
	...
	public double cal_netBaseUSD() {
		...
		if (moneymarket.getAmount_GBP() > 0)
			USD_Base = USD_Base + (moneymarket.getAmount_GBP() * rate.GBP_USD_BID);
		else
			USD_Base = USD_Base + (moneymarket.getAmount_GBP() * rate.GBP_USD_ASK);

		if (moneymarket.getAmount_EURO() > 0)
			USD_Base = USD_Base + (moneymarket.getAmount_EURO() * rate.EUR_USD_BID);
		else
			USD_Base = USD_Base + (moneymarket.getAmount_EURO() * rate.EUR_USD_ASK);
