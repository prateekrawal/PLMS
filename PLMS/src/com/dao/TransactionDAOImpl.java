...
public class TransactionDAOImpl implements TransactionDAO {
	...
	@Override
	public int addTransaction(ArrayList<Transaction> t_AL) {
		...
		try {		
			...
			ps.setString(3, String.valueOf(t_AL.get(i).getDebitCredit()));
			//String.valueOf(myChar))
			ps.setDouble(4, t_AL.get(i).getAmount());
			ps.setString(5, String.valueOf(t_AL.get(i).getTimestamp()));
